# Operator Quickstart — Sewerage Operations Coordination

Shortest path from clone to a verified local dry-run for **ISIC 3700** (`cloud-itonami-isic-3700`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-3700.git
cd cloud-itonami-isic-3700
```
...
- Blueprint governor key: `sewerage-ops-governor`
- Likely source path: `sewerops.governor.cljc`
